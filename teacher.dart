...
void main() {
  runApp(const MaterialApp(home: TeacherAttendanceView(role: 'Teacher')));
}
      ...
      body: Padding(
        ...
        child: Column(
          children: [
              ...
              onPressed: () {
                if (selectedHour != null && selectedYear != null && selectedClass != null) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('Attendance Marked for $selectedClass on ${DateFormat('yyyy-MM-dd').format(selectedDate)}')),
                  );
                } else {
                  ScaffoldMessenger.of(context).showSnackBar(
            ...
            ElevatedButton(
              onPressed: () {
                // Navigate to AttendanceScreen (ensure it's defined)
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const AttendanceScreen(role: 'Teacher')),
                );
              },
...
// Placeholder for AttendanceScreen class
class AttendanceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const Center(child: Text('Attendance Records will be displayed here')),
    );
  }
}
