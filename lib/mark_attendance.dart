...
class _AttendanceScreenState extends State<AttendanceScreen> {
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: [
          ...
          _buildDecorativeElement(screenWidth > 442.68 ? 442.68 : screenWidth * 0.9, -12, 0.49, screenWidth),
          _buildDecorativeElement(-52, containerHeight * 0.9, -0.13, screenWidth),
          _buildDecorativeElement(containerWidth * 0.5, containerHeight * 0.9, 0.76, screenWidth),
          _buildDecorativeElement(-113.26, containerHeight * 0.75, 0.43, screenWidth),
  ...
  Widget _buildDecorativeElement(double left, double top, double rotateZ, double screenWidth) {
    return Positioned(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: isPresent ? Color(0xFF3E5879) : Colors.red,
